...
class LoadMatBatch(BaseCommand):

    args = '<organism_name, organism_version, batch_name, ' + \
           'batch_description, first_name, last_name, ' + \
           'affiliation, email, ip, batch_directory>'
